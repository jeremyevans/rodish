...
The +help_order+ method configures the order of help sections.  By default,
the order is:

  help_order(:desc, :banner, :commands, :options)

You can use this method to reorder and/or supress sections.
...
default_help_order :: Support overriding order of help sections for all commands.
